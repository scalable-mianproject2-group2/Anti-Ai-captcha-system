...
# # ai_solver.py (improved, robust, debug-friendly)
# import requests
# import os
# import librosa
# import numpy as np
...
# def main():
#     # 1) ask server which captcha is current (avoid scraping races)
#     try:
...
#     # 3) load and preprocess exactly like training/test script
#     try:
...
#     # 5) post the AI result (with confidence and top3) to server so frontend can show it
#     post_payload = {
#         "predicted": predicted,
